...
package_source:
	...
	/usr/bin/cpack --config ./CPackSourceConfig.cmake /work/CPackSourceConfig.cmake
...
#=============================================================================
# Target rules for targets named canpi

# Build rule for target.
canpi: cmake_check_build_system
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 canpi
.PHONY : canpi

# fast build rule for target.
canpi/fast:
	$(MAKE) $(MAKESILENT) -f canpi/CMakeFiles/canpi.dir/build.make canpi/CMakeFiles/canpi.dir/build
.PHONY : canpi/fast
